    ...
    try {
      ...
      if (songIdMatch && request.method === 'PUT') {
        ...
        await env.DB.prepare(
          `INSERT INTO songs (uuid, name, bpm, speed, file_name, mime_type, r2_key, created_at, updated_at)
           VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
        ...
        ).bind(uuid, name, bpm, speed || 40, fileName, mimeType, r2Key, createdAt || Date.now(), updatedAt).run();
